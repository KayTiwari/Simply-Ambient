...
- The full two-ear ripple field plays again during sound on Android, all three rings per side at the band's tempo. The rings are cheap native strokes; only the mid-screen glow and corner ripples stay retired there as the remaining thermal trim.
